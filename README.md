...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/your-username/graph-rag-academic.git](https://github.com/your-username/graph-rag-academic.git)
    cd graph-rag-academic
    ```
...
We ship a minimal web service and UI for querying the data.
